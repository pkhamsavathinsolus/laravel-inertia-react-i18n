 ...
 */
export function LaravelReactI18nProvider({ awaitLangLoad = isServer, children, ...currentOptions }) {
    const [options, setOptions] = React.useState({ ...defaultOptions, ...currentOptions });
